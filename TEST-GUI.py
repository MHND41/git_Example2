...
# Function to handle the form submission and generate configuration
def generate_config():
    Vlan_uplink = entry_vlan_uplink.get()
    IP_address_uplink = entry_ip_uplink.get()
    LoopBack_IP = entry_loopback_ip.get()
    Hostname = entry_Hostname.get()
    SNMP_Describtion = entry_SNMP_Describtion.get()
    Vlan10_Virtual_IP = entry_Vlan10_Virtual_IP.get()
    Vlan10_IP_Address = entry_Vlan10_IP_Address.get()
    Vlan20_Virtual_IP = entry_Vlan20_Virtual_IP.get()
    Vlan20_IP_Address = entry_Vlan20_IP_Address.get()
    Vlan30_Virtual_IP = entry_Vlan30_Virtual_IP.get()
    Vlan30_IP_Address = entry_Vlan30_IP_Address.get()
    Vlan40_Virtual_IP = entry_Vlan40_Virtual_IP.get()
    Vlan40_IP_Address = entry_Vlan40_IP_Address.get()
    Vlan500_Virtual_IP = entry_Vlan500_Virtual_IP.get()
    Vlan500_IP_Address = entry_Vlan500_IP_Address.get()
    SONiC_SW01 = entry_SONiC_SW01.get()
    SONiC_SW02 = entry_SONiC_SW02.get()
    SONiC_SW03 = entry_SONiC_SW03.get()
    Port_Number_in_Core = entry_Port_Number_in_Core.get()
...
interface ethernet1/1/15:1
 description uplink-rr3core4k1-Te1/{Port_Number_in_Core}
 no shutdown
...
"""
    ...
    result_text.insert(tk.END, config_text)  # Insert new configuration
    result_text.config(state=tk.DISABLED)  # Disable editing
    result_text.tag_add("green", "1.0", tk.END)  # Tag the text from start to end
    result_text.tag_configure("green", foreground="spring green")  # Set the color of the tagged text to green


# Font style for bold labels
bold_font = ('Helvetica', 10, 'bold')  # Choose your font family and size


# Create the main window
root = tk.Tk()
root.title("Network Configuration Generator Distro-01-RR3")



# Create and place labels and input fields
label_vlan_uplink = tk.Label(root, text="Enter uplink VLAN:", font=bold_font)
label_vlan_uplink.grid(row=0, column=0, padx=10, pady=5, sticky='e')

entry_vlan_uplink = tk.Entry(root)
entry_vlan_uplink.grid(row=0, column=1, padx=10, pady=5, sticky='w')


label_ip_uplink = tk.Label(root, text="Enter IP address uplink with subnet:", font=bold_font)
label_ip_uplink.grid(row=1, column=0, padx=10, pady=5, sticky='e')

entry_ip_uplink = tk.Entry(root)
entry_ip_uplink.grid(row=1, column=1, padx=10, pady=5, sticky='w')


label_loopback_ip = tk.Label(root, text="Enter Loopback IP address:", font=bold_font)
label_loopback_ip.grid(row=2, column=0, padx=10, pady=5, sticky='e')

entry_loopback_ip = tk.Entry(root)
entry_loopback_ip.grid(row=2, column=1, padx=10, pady=5, sticky='w')


label_Hostname = tk.Label(root, text="Enter Hostname:", font=bold_font)
label_Hostname.grid(row=3, column=0, padx=10, pady=5, sticky='e')

entry_Hostname = tk.Entry(root)
entry_Hostname.grid(row=3, column=1, padx=10, pady=5, sticky='w')


label_SNMP_Describtion = tk.Label(root, text="Enter SNMP Describtion:", font=bold_font)
label_SNMP_Describtion.grid(row=4, column=0, padx=10, pady=5, sticky='e')

entry_SNMP_Describtion = tk.Entry(root)
entry_SNMP_Describtion.grid(row=4, column=1, padx=10, pady=5, sticky='w')


label_Vlan10_Virtual_IP = tk.Label(root, text="Enter Vlan10 Virtual IP:", font=bold_font)
label_Vlan10_Virtual_IP.grid(row=5, column=0, padx=10, pady=5, sticky='e')

entry_Vlan10_Virtual_IP = tk.Entry(root)
entry_Vlan10_Virtual_IP.grid(row=5, column=1, padx=10, pady=5, sticky='w')


label_Vlan10_IP_Address = tk.Label(root, text="Enter Vlan10 IP Address:", font=bold_font)
label_Vlan10_IP_Address.grid(row=6, column=0, padx=10, pady=5, sticky='e')

entry_Vlan10_IP_Address = tk.Entry(root)
entry_Vlan10_IP_Address.grid(row=6, column=1, padx=10, pady=5, sticky='w')


label_Vlan20_Virtual_IP = tk.Label(root, text="Enter Vlan20 Virtual IP:", font=bold_font)
label_Vlan20_Virtual_IP.grid(row=7, column=0, padx=10, pady=5, sticky='e')

entry_Vlan20_Virtual_IP = tk.Entry(root)
entry_Vlan20_Virtual_IP.grid(row=7, column=1, padx=10, pady=5, sticky='w')


label_Vlan20_IP_Address = tk.Label(root, text="Enter Vlan20 IP Address:", font=bold_font)
label_Vlan20_IP_Address.grid(row=8, column=0, padx=10, pady=5, sticky='e')

entry_Vlan20_IP_Address = tk.Entry(root)
entry_Vlan20_IP_Address.grid(row=8, column=1, padx=10, pady=5, sticky='w')


label_Vlan30_Virtual_IP = tk.Label(root, text="Enter Vlan30 Virtual IP:", font=bold_font)
label_Vlan30_Virtual_IP.grid(row=9, column=0, padx=10, pady=5, sticky='e')

entry_Vlan30_Virtual_IP = tk.Entry(root)
entry_Vlan30_Virtual_IP.grid(row=9, column=1, padx=10, pady=5, sticky='w')


label_Vlan30_IP_Address = tk.Label(root, text="Enter Vlan30 IP Address:", font=bold_font)
label_Vlan30_IP_Address.grid(row=10, column=0, padx=10, pady=5, sticky='e')

entry_Vlan30_IP_Address = tk.Entry(root)
entry_Vlan30_IP_Address.grid(row=10, column=1, padx=10, pady=5, sticky='w')


label_Vlan40_Virtual_IP = tk.Label(root, text="Enter Vlan40 Virtual IP:", font=bold_font)
label_Vlan40_Virtual_IP.grid(row=11, column=0, padx=10, pady=5, sticky='e')

entry_Vlan40_Virtual_IP = tk.Entry(root)
entry_Vlan40_Virtual_IP.grid(row=11, column=1, padx=10, pady=5, sticky='w')


label_Vlan40_IP_Address = tk.Label(root, text="Enter Vlan40 IP Address:", font=bold_font)
label_Vlan40_IP_Address.grid(row=12, column=0, padx=10, pady=5, sticky='e')

entry_Vlan40_IP_Address = tk.Entry(root)
entry_Vlan40_IP_Address.grid(row=12, column=1, padx=10, pady=5, sticky='w')


label_Vlan500_Virtual_IP = tk.Label(root, text="Enter Vlan500 Virtual IP:", font=bold_font)
label_Vlan500_Virtual_IP.grid(row=13, column=0, padx=10, pady=5, sticky='e')

entry_Vlan500_Virtual_IP = tk.Entry(root)
entry_Vlan500_Virtual_IP.grid(row=13, column=1, padx=10, pady=5, sticky='w')


label_Vlan500_IP_Address = tk.Label(root, text="Enter Vlan500 IP Address:", font=bold_font)
label_Vlan500_IP_Address.grid(row=14, column=0, padx=10, pady=5, sticky='e')

entry_Vlan500_IP_Address = tk.Entry(root)
entry_Vlan500_IP_Address.grid(row=14, column=1, padx=10, pady=5, sticky='w')


label_SONiC_SW01 = tk.Label(root, text="Enter SONiC SW01:", font=bold_font)
label_SONiC_SW01.grid(row=15, column=0, padx=10, pady=5, sticky='e')

entry_SONiC_SW01 = tk.Entry(root)
entry_SONiC_SW01.grid(row=15, column=1, padx=10, pady=5, sticky='w')


label_SONiC_SW02 = tk.Label(root, text="Enter SONiC SW02:", font=bold_font)
label_SONiC_SW02.grid(row=16, column=0, padx=10, pady=5, sticky='e')

entry_SONiC_SW02 = tk.Entry(root)
entry_SONiC_SW02.grid(row=16, column=1, padx=10, pady=5, sticky='w')


label_SONiC_SW03 = tk.Label(root, text="Enter SONiC SW03:", font=bold_font)
label_SONiC_SW03.grid(row=17, column=0, padx=10, pady=5, sticky='e')

entry_SONiC_SW03 = tk.Entry(root)
entry_SONiC_SW03.grid(row=17, column=1, padx=10, pady=5, sticky='w')


label_Port_Number_in_Core = tk.Label(root, text="Enter Port Number in Core:", font=bold_font)
label_Port_Number_in_Core.grid(row=18, column=0, padx=10, pady=5, sticky='e')

entry_Port_Number_in_Core = tk.Entry(root)
entry_Port_Number_in_Core.grid(row=18, column=1, padx=10, pady=5, sticky='w')



# Create and place the generate button
generate_button = tk.Button(root, text="Generate Configuration", command=generate_config)
generate_button.grid(row=19, column=0, columnspan=2, pady=10)

# Create and place a text box for displaying the generated configuration
result_text = tk.Text(root, height=30, width=140, wrap=tk.WORD, state=tk.DISABLED, bg="black")
result_text.grid(row=21, column=0, columnspan=2, padx=10, pady=10)
